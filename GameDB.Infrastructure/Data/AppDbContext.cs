...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Alert>(entity =>
        {
            ...
            entity.Property(e => e.AutoUpdateMode)
                .HasMaxLength(20)
                .HasDefaultValueSql("''::character varying");

            entity.HasOne(d => d.Game).WithMany(p => p.Alerts).HasForeignKey(d => d.GameId);

            entity.HasOne(d => d.Shop).WithMany(p => p.Alerts).HasForeignKey(d => d.ShopId);
        ...
        modelBuilder.Entity<Game>(entity =>
        {
            ...
            entity.Property(e => e.ImportStatus)
                ...
                .HasSentinel((GameImportStatus)255)
                .HasConversion(
                    v => v.ToString(),
                    v => Enum.Parse<GameImportStatus>(v));
        ...
        modelBuilder.Entity<GameExternalId>(entity =>
        {
            ...
            entity.HasOne(d => d.Game).WithMany(p => p.GameExternalIds).HasForeignKey(d => d.GameId);

            entity.HasOne(d => d.Shop).WithMany(p => p.GameExternalIds).HasForeignKey(d => d.ShopId);
        });
        ...
        modelBuilder.Entity<GameOffer>(entity =>
        {
            ...
            entity.HasOne(d => d.External).WithMany(p => p.GameOffers)
                .HasForeignKey(d => d.ExternalId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("FK_GameOffer_GameExternalId_Id");
        });
        ...
        modelBuilder.Entity<GameShop>(entity =>
        {
            ...
            entity.HasIndex(e => e.ItadShopId, "UQ_GameShop_ItadShopId")
                .IsUnique()
                .HasFilter("(\"ItadShopId\" IS NOT NULL)");

            entity.Property(e => e.Slug).HasDefaultValueSql("''::text");
        });
        ...
        modelBuilder.Entity<PriceHistory>(entity =>
        {
            ...
            entity.Property(e => e.LastSyncedAt).HasDefaultValueSql("now()");
